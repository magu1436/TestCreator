...
class DropZone{
    ...
    readonly dropedFiles: ImageFile[] = [];
    ...
    constructor(){
        ...
        if(elem instanceof HTMLDivElement){
            ...
            throw new Error(`The ${DropZone.id} elemet does not exist.`);
        }
    ...
    protected counterUpdate(){
        this.counter.textContent = `${this.dropedFiles.length} 枚`;
    }
    ...
    toggleDisplayingBody(){
        const isDisplayInitBody = (this.dropedFiles.length == 0);
